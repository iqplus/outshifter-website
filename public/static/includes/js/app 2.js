var App = function () {
    ...
    var config = {
        showStats: true,
        background: "#CCCCCC", //"RGB(238,238,238)",
    ...
    function init() {
        ...
        vars.dom.canvas1 = document.getElementById("canvas1"); // WebGL/ThreeJS
        vars.dom.canvas2 = document.getElementById("canvas2"); // Gradients
