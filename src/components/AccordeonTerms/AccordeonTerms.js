            ...
            >
                ...
                <ul className="list-unstyled">
                    <li className="sidebar-item sidebar-item-first">
                        <a onClick={this.props.toggle1}><img src={IconTerms}/>General Terms</a>
                                ...
                                <div id="general-terms">
                                    ...
                                    <div className="terms-titel-2">
                                        ...
                                        <p>
                                            ...
                                            <strong>“Merchant”</strong> means a person or company listing products or services available for outshifting (see definition below) through the Outshifter Platform.<br/>
                                            <br/>
                                            ...
                                            <br/>
                                            Mediators and Merchants alone are responsible for identifying, understanding, and complying to local laws and regulations, such as, but not limited to taxes, advertising and consumer protection regulations. Outshifter allows for user generated content in the form of product profiles and service profiles, thus Outshifter cannot guarantee the accuracy and applicability of this content. Whenever purchasing products and services from Merchants utilizing the Outshifter Platform, the sales contract is with the Customer and the Merchant. Outshifter is at no point liable for the delivery of any kind of goods.<br/>
                                        </p>
                                    </div>
                                    ...
                                    <div id="general-terms-1" className="terms-description">
                                        ...
                                        <p>
                                            1.1 “<strong>Outshifting</strong>” is the general expression applied to the action of placing products or services to different and multiple online mediums, channels, platforms and webpages. The technical solution or functionality used to provide this service may differ amongst the various mediums, channels, platforms, and webpages. Outshifter AS provides users with e-commerce infrastructure and services which allow for the outshifting of products and services and the tracking of products and services facilitated through the Outshifter Platform.
                                            <br/><br/>
                                            1.2 Outshifter does not own, create, sell, resell, provide, control, manage, offer, deliver, or supply any of the products and/or services listed on and through our platform and infrastructure. Merchants and Mediators alone are responsible for their Outshifting activities, posts, and engagements. When users of the Outshifter platform engage in outshifting, they are entering into contract directly with each other. Outshifter is not acting as an agent or representative on behalf of any of the Mediators and Merchants utilizing our Platform. Outshifter is not liable for delivery of any kind of goods as a result of the transactional contracts made through outshifting, except as it pertains to payments.
                                            <br/><br/>
                                            ...
                                            <br/><br/>
                                            1.4 While we strive to offer the best possible experience and service, we do not guarantee or control (i) the quality, safety, suitability, existence and legality of user created content and listings on the Outshifter Platform; or (ii) the performance, conduct, content and delivery of any Merchant, Mediator, or Third-Party. Merchants and Mediators are solely liable for how they act and present themselves through the Outshifter Platform. We do not endorse any of the products, services and content listed on, or facilitated by the Outshifter Platform. We do not take any responsibility and liability for any of the content and listings Merchants and Mediators convey through the Outshifter Platform to Third-Party Services and their conduct on such Third-Party Services. 
                                            <br/><br/>
                                    ...
                                    <div id="general-terms-6" className="terms-description">
                                        <h5>6. Payments</h5>
                                        <p>
                                            6.1 Outshifter allows for payment processing services to be provided by third-party vendors according to the choice of the Mediator and Merchant. The terms and conditions and privacy practices of these vendors might be different from ours. Through purchasing goods and/or services through third party vendors you agree to their terms and conditions and privacy policies. Please review their term and conditions and privacy policies carefully. 
                                            <br/><br/>
                                    ...
                                    <div id="general-terms-9" className="terms-description">
                                        <h5>9. Information About Listed Product and Services</h5>
                                        <p>
                                            Outshifter is not the manufacturer, handler, seller, distributor, designer, or producer of the products and services sold and listed through our Platform. Outshifter simply allows for outshifting to take place. While we work to ensure that product and service information appearing on product listings through our platform is correct, we cannot guarantee the accuracy of such listings. All information about the products and services on our platform is provided for information purposes only and is uploaded by our Platform users. We recommend that you do not rely solely on the information presented in the listings. Please always read labels, warnings and directions provided with the product and service before use. Outshifter accepts no liability for inaccuracies or misstatements about products and services by Merchants and Third-Parties. 
                                        </p>
                                    </div>
                                    ...
                                    <div id="general-terms-10" className="terms-description">
                                        <h5>10. Content</h5>
                                        <p>
                                            10.1 You own the content you upload to the Outshifter Platform and can do with it as you see fit. By uploading content to the Outshifter Platform you declare that you own or have the right to use the content in this manner and that this does not infringe any Third-Party intellectual property rights. Outshifter never owns or claim to own any of the content and listings you create and upload to our Platform. However, in order for us to provide the Outshifter Platform, we need the legal permission to use your content. Through this agreement you grant us a royalty free non-exclusive, transferable, sub-licensable, and worldwide license to host, use, distribute, copy, run, modify (e.g. for technical purposes, such as making sure your submission is viewable on an iPhone as well as a computer), and display the content uploaded by you to our Platform. You can revoke this license at any time by deleting the content in question or stop using the Outshifter Platform.
                                            <br/><br/>
                                            10.2 Content on the Outshifter Platform and listings (product and service profiles) on the Outshifter Platform made available for outshifting is user created content. While we work to ensure content and listings adheres to our standards and follows local laws and regulations, it is created by the Merchants and Mediators using our platform and Outshifter cannot guarantee for the claims made, copyrights, accuracy, and quality of the content. All Mediators and Merchants using Outshifter are solely responsible for the content they make available through our Platform and required to follow local consumer, tax, advertising and copyright laws and regulations in order to use the Outshifter Platform. 
                                        </p>
                                    </div>

                                    <div id="general-terms-11" className="terms-description">
                                        <h5>11. Prohibited Items and Services</h5>
                                        <p>
                                            All products listed and sold through our services have to comply to local laws and regulations, as well as Outshifter´s policies. Please keep in mind that when outshifting to Third-Party platforms, these platforms might have different policies than us regarding what is prohibited items and services. 
                                            <br/><br/>
                                            The following are examples of prohibited products and services including, but not restricted to: 
                                            <ul>
                                            ...
                                            <br/><br/>
                                            Outshifter reserves the right to suspend your account without any reason, at any time without notice and liability to you.
                                        </p>
                                    </div>
                                    ...
                                    <div id="general-terms-12" className="terms-description">
                                        ...
                                        <p>
                                            You agree that: (i) We may use mechanisms that rate, or allow Customers, Merchants and Mediators to rate, products, services and performance of Merchants and Mediators on the Outshifter Platform, we may make these ratings and feedback available within the Outshifter Platform; (ii) Outshifter cannot be held liable for your interactions and contracts with Merchants, Mediators and other Third-Party platforms; (iii) you will not contact or solicit Mediators and Merchants met through our platform. Any communication and/or transaction done outside our provided structure and platform is solely at your own risk. 
                                        </p>
                                    </div>
                                    ...
                                    <div id="general-terms-15" className="terms-description">
                                        ...
                                        <p>
                                            ...
                                            <br/><br/>
                                            AS OUTSHIFTER IS NOT THE RESPONSIBLE PARTY IN THE TRANSACTION BETWEEN THE CUSTOMER AND THE MERCHANT OR THE MEDIATOR, NOR THE RESPONSIBLE PARTY FOR CONTRACT SPECIFICS BETWEEN THE MERCHANT AND THE MEDIATOR, WE WILL NOT BE INVOLVED IN ANY POTENTIAL DISPUTE(S) SHOULD ONE ARISE BETWEEN YOU AND/OR ANY OF THE OTHER PARTIES. EACH PARTICIPANT IN A DISPUTE RELEASE OUTSHIFTER AND ITS EMPLOYEES, DIRECTORS AND OFFICERS FROM ANY CLAIMS, DAMAGES AND DEMANDS.                    </p>
                                    </div>
                    ...
                    <li className="sidebar-item">
                        <a onClick={this.props.toggle2}><img src={IconPrivacy}/>Privacy Policy</a>
