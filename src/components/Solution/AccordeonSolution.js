        ...
        return (
            ...
            >
                ...
                <div className="terms-titel-2">
                    ...
                    <p>
                    One complete solution for all your online sales-channels. Distribute cross-platform with powerfull listing tools and integrations that bridges content seamlessly.
                    </p>
                </div>
                ...
                <ul className="list-unstyled">
                    <li className="sidebar-item sidebar-item-first">
                        <a onClick={this.props.toggle1}><img src={Logo}/>About Outshifting</a>
